...
- **Phase 15.2A Beta Deployment Prep with Manual QA Gate**：准备 Beta 部署所需文档（beta-release-gate.md / beta-deployment-checklist.md 更新）；明确 10 项 Hard Gate 人工验收条件；清理文档状态残留；当前不公开发布，等待 Phase 15.2B Preview/Staging 部署 + Phase 15.2C 真实浏览器验收完成
